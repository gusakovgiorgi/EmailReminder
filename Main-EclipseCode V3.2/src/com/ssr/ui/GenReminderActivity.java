...
public class GenReminderActivity extends Activity {
		...
		cbtn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (title.getText().toString().equals("")
					...
					Toast.makeText(GenReminderActivity.this, "Invalid Input",
							Toast.LENGTH_SHORT).show();
				} 	try {
					if(com.ssr.bl.DateTimeProc.isInValidDateTime( date.getText().toString()
							,time.getText().toString())){
						Toast.makeText(GenReminderActivity.this,
								"Invalid Date Time, Date Time cant be older. Reminder not created.", Toast.LENGTH_SHORT).show();
					}else {
						GeneralReminder mr = new GeneralReminder();
						mr.createGeneralReminder(title.getText().toString(), detail
								.getText().toString(), date.getText().toString(),
								time.getText().toString(), GenReminderActivity.this);
