...
public class BirthdayReminderActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		cbtn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				EditText birthdayof = (EditText) findViewById(R.id.editText1);
				EditText ai = (EditText) findViewById(R.id.editText2);
				...
				if (birthdayof.getText().toString().equals("")
					...
					try {
						if(com.ssr.bl.DateTimeProc.isInValidDateTime( date.getText().toString()
							...
							BirthdayReminder mr = new BirthdayReminder();
							mr.createBirthdayReminder(birthdayof.getText().toString(),
									ai.getText().toString(), date.getText().toString(),
									time.getText().toString(),
									BirthdayReminderActivity.this);
							Toast.makeText(BirthdayReminderActivity.this,
