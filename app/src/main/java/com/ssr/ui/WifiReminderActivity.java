...
public class WifiReminderActivity extends Activity {
	 ...
	 * 
	 * private int pHour; private int pMinute;
	 */
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final WiFiManager wmman=new WiFiManager();
		...
		cbtn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (time.getText().toString().trim().equals("")) {
					Toast.makeText(WifiReminderActivity.this, "Invalid Input",
							Toast.LENGTH_SHORT).show();
				} 
				else if(!wmman.isWiFiOn(WifiReminderActivity.this)){
					Toast.makeText(WifiReminderActivity.this, "Can't create Reminder, because WIFI is Off",
							Toast.LENGTH_SHORT).show();
				}
				else {
					WifiReminder mr = new WifiReminder();
					int minz = Integer.parseInt(time.getText().toString()
							.trim());
					mr.createWifiReminder(minz, WifiReminderActivity.this);

					Toast.makeText(WifiReminderActivity.this,
